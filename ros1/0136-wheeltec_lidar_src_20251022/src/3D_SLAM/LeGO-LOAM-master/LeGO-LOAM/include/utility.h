...
extern const string pointCloudTopic = "/point_cloud_raw";
extern const string imuTopic = "none";

// Save pcd
extern const string fileDirectory = "/home/wheeltec/wheeltec_lidar/src/data/LeGO-LOAM/";
...
extern const int Horizon_SCAN = 1300;
