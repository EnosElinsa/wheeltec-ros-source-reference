...
def play_audio_file(audio_file_path):
	def _play_audio():
		...
		# 	subprocess.run(['aplay', '-q', audio_file_path], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, timeout=10)
