 ...
 */
public class MapnavActivity extends RosAppActivity {
	...
	private com.example.myapplication.MapPosePublisherLayer mapPosePublisherLayer;
	...
	public void startMasterChooser() {
		...
		String masterURI = prefs.getString("masterURI", "http://"+MainActivity.set_ip_text.getText()+":11311");
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setMainWindowResource(R.layout.activity_map_nav);
		...
		Glide.with(MapnavActivity.this).load(R.drawable.camera).apply(options).into(cameraView);
		getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);//设置不息屏
		TextView TX = (TextView) findViewById(R.id.textView2);
        TX.setText(MainActivity.car_model);
	...
	protected void init(NodeMainExecutor nodeMainExecutor) {
		...
		com.map_nav.myapplication.ViewControlLayer viewControlLayer =
                new com.map_nav.myapplication.ViewControlLayer(this,
        ...
        String planTopic     = remaps.get(MainActivity.planTopic);
		...
		String mapFrame    = (String) params.get("map_frame", getString(R.string.map_frame));
        ...
        mapPosePublisherLayer = new com.example.myapplication.MapPosePublisherLayer(this, appNameSpace, params, remaps);
        com.example.myapplication.InitialPoseSubscriberLayer initialPoseSubscriberLayer =
                new com.example.myapplication.InitialPoseSubscriberLayer(appNameSpace.resolve(initTopic).toString(), robotFrame);
...
//			layoutParams.width = (int) (width * 0.03);
...
//		layoutParams.width = ViewGroup.LayoutParams.WRAP_CONTENT;
	...
	private void readAvailableMapList() {
        ...
        com.map_nav.myapplication.MapManager mapManager = new com.map_nav.myapplication.MapManager(this, remaps);
	...
	private void showWaitingDialog(final CharSequence title,
		...
		waitingDialog = ProgressDialog.show(MapnavActivity.this, title, message,
				true);
