...
from wheeltec_arm_pick.msg import color_ik_result as color_ik_result
...
col_blue = (95,138,46,110,255,255)# blue
col_green= (55,95,46,86,255,255)# green
col_yellow = (25,100,46,40,255,255)# yellow
...
class Find_Color:
    ...
    def publish_flag(self):
        ...
        # rospy.loginfo('visual_follow_flag=%d',visual_follow_flag.data)
    ...
    def image_callback(self, msg):
        ...
        image = image0[int(self.pictureHeight/16):int(self.pictureHeight/16*12),int(self.pictureWidth/16*4):int(self.pictureWidth/16*15)]
