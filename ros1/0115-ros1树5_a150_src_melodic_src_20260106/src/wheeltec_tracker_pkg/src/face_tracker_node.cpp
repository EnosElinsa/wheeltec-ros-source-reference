...
public:
  ...
  haar_file_face = "/home/wheeltec/A150_SRC_Melodic/src/wheeltec_tracker_pkg/data/face.xml";
  face_tracking = 1;
  ...
  void imageCb(const sensor_msgs::ImageConstPtr& msg)
  {
    ...
    catch (cv_bridge::Exception& e)
    {
      ...
      return;
	    ...
	    //Harr分类器文件代码
	    string cascadeName = "/home/wheeltec/A150_SRC_Melodic/src/wheeltec_tracker_pkg/data/face.xml";
