...
// Pre-compute the sine and cosine for the altitude angles.
    ...
    public:
        ...
        int scan_num{};
        int point_num{};
        std::vector<int> disable_angle_min_vec;
        std::vector<int> disable_angle_max_vec;
    ...
    private:
        ...
        std::vector<LslidarDriver::AngleRange> calculateDisableAngles(const std::vector<int>& disableMin, const std::vector<int>& disableMax);
