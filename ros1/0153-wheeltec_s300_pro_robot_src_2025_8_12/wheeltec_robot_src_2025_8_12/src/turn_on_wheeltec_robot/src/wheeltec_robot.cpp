...
//设置灯带颜色服务
bool turn_on_robot::Set_LightRgb_Callback(turn_on_wheeltec_robot::SetRgb::Request &req,turn_on_wheeltec_robot::SetRgb::Response &res)
{
...
turn_on_robot::turn_on_robot():Sampling_Time(0),Power_voltage(0)
{
  ...
  private_nh.param<std::string>("car_mode",         car_mode,    "S300"); //机器人型号
