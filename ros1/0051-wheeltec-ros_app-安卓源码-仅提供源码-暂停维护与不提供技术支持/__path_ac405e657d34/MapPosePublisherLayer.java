...
public class MapPosePublisherLayer extends DefaultLayer {
    ...
    private Publisher<geometry_msgs.PointStamped> clickedPointPublisher;
    ...
    private String clickedPointTopic;
    ...
    public MapPosePublisherLayer(final Context context,
        ...
        this.clickedPointTopic = remaps.get(context.getString(R.string.clicked_point_topic));
...
//                        covariance[6 * 5 + 5] = (float) (Math.PI / 12.0 * Math.PI / 12.0);
                        ...
                        PointStamped clickedPoint = clickedPointPublisher.newMessage();
                        clickedPoint.getHeader().setFrameId(mapFrame);
                        clickedPoint.setPoint(poseStamped.getPose().getPosition());
...
//                        goalPublisher.publish(message);
    ...
    public void onStart(final VisualizationView view, ConnectedNode connectedNode) {
        ...
        clickedPointPublisher = connectedNode.newPublisher(nameResolver.resolve(clickedPointTopic).toString(),
