...
int main(int argc, char **argv) {
  ...
  nh_private.param("device_ip", devip_str_,std::string("192.168.1.200"));
  nh_private.param("difop_ip", devip_str_difop,std::string("192.168.1.102"));
  nh_private.param("group_ip", group_ip, std::string("224.1.1.2"));
  nh_private.param("device_port", UDP_PORT_NUMBER_DIFOP,2369);
  nh_private.param("difop_port", UDP_PORT_NUMBER,2368);
