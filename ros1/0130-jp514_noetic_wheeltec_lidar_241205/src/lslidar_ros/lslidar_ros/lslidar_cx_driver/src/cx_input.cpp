#include "lslidar_cx_driver/cx_input.h"
...
int InputSocket::getPacket(lslidar_msgs::LslidarPacket_cxPtr &pkt)
{
  struct pollfd fds[1];
  fds[0].fd = sockfd_;
  fds[0].events = POLLIN;
...
/** @brief Get one lslidar packet. */
int InputPCAP::getPacket(lslidar_msgs::LslidarPacket_cxPtr &pkt)
{
