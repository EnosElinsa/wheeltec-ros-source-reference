...
{
    killall->start("sh /home/HwHiAiUser/wheeltec_ros2/src/qt_ros_test/script/killall.sh\n");
}
...
void qt_ros_test::MainWindow::on_pushButton_webusbcam_clicked(bool checked)
{
    if(ui.pushButton_webusbcam->isChecked())
    {
        ...
        _cmd->write("sh /home/HwHiAiUser/wheeltec_ros2/src/qt_ros_test/script/web.sh\n");
        ui.checkBox__opencamera->setChecked(true);
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_2dmap_clicked(bool checked)
{
    ...
    {
        _cmd->write("sh /home/HwHiAiUser/wheeltec_ros2/src/qt_ros_test/script/gmapping.sh\n");
        ui.checkBox_key->setChecked(true);
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_2dmap_2_clicked()
{
    ...
    {
        _cmd->write("sh /home/HwHiAiUser/wheeltec_ros2/src/qt_ros_test/script/slam_toolbox.sh\n");
        ui.checkBox_key->setChecked(true);
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_2dmap_3_clicked()
{
    ...
    {
        _cmd->write("sh /home/HwHiAiUser/wheeltec_ros2/src/qt_ros_test/script/cartographer.sh\n");
        ui.checkBox_key->setChecked(true);
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_2dnav_clicked(bool checked)
{
    ...
    {
        _cmd->write("sh /home/HwHiAiUser/wheeltec_ros2/src/qt_ros_test/script/nav.sh\n");
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_3dnav_clicked(bool checked)
{
    ...
    {
        _cmd->write("sh /home/HwHiAiUser/wheeltec_ros2/src/qt_ros_test/script/rtabnav.sh\n");
        ui.checkBox__opencamera->setChecked(true);
        ui.checkBox_key->setChecked(true);
        btn_disableall(true);
