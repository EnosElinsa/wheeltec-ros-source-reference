...
#存放充电桩位置的文件位置
json_file='/home/HwHiAiUser/wheeltec_ros2/src/auto_recharge_ros2/Charger_Position.json'
yaml_file='/home/HwHiAiUser/wheeltec_ros2/src/auto_recharge_ros2/robot_info.yaml'
