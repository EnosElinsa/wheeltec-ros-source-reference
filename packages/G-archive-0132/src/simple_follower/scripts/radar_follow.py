...
import math
import numpy as np
#from sensor_msgs.msg import Joy, radarScan
from geometry_msgs.msg import Twist, Vector3
from simple_follower.msg import position as PositionMsg
from std_msgs.msg import String as StringMsg
from dynamic_reconfigure.server import Server
#from simple_follower.cfg import radar_paramsConfig
...
class Follower:
	def __init__(self):
		...
		# Dynamic Reconfigure
		#self.dynamic_reconfigure_server = Server(radar_paramsConfig, self.reconfigCB) # 创建dynamic reconfigure服务，实现在线调参
	...
	def publish_flag(self):
		...
		radar_follow_flag=Int8()
		radar_follow_flag.data=1
		radarfwflagPublisher.publish(radar_follow_flag)
		rospy.loginfo('a=%d',radar_follow_flag.data)
...
class simplePID:
	...
	def update(self, current_value):
		...
		# 偏差较da时停止移动
		if error[1]>5.0 or error[1]<-5.0: # error[1]为距离偏差
			error[1]=0.0
...
if __name__ == '__main__':
	...
	print('starting')
	radarfwflagPublisher = rospy.Publisher('/radar_follow_flag', Int8, queue_size =1)
