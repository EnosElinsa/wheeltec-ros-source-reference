...
typedef struct  
{
  float WheelSpacing;      //Wheelspacing, Mec_Car is half wheelspacing //轮距 四驱车为半轮距
  float AxleSpacing;       //Axlespacing, Mec_Car is half axlespacing //轴距 四驱车为半轴距	
...
#define SENIOR_4WD_BS_wheelspacing   0.160 
