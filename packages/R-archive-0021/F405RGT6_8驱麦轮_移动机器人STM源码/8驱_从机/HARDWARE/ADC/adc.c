...
{    
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_ADC1, ENABLE); //使能ADC1时钟
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AN;	//Power supply voltage analog input pin //电源电压模拟输入引脚
	GPIO_Init(GPIOA, &GPIO_InitStructure);	
	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AN;	//Potentiometer analog input pin, used to switch car model //电位器模拟输入引脚，用于切换小车型号
