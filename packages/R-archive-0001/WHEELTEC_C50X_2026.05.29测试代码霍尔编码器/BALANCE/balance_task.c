...
static void ResponseControl(void)
{
	...
	else if ( robot.type <= 1 || robot.type == 9)   Set_Pwm(-2000 ,-3000 , 0 , 0 ,robot.SERVO.Output ); //高配阿克曼-MD36电机
	else if ( robot.type >= 2 && robot.type <= 5 )  Set_Pwm(-2000 ,-3000 , 0 , 0 ,robot.SERVO.Output ); //顶配阿克曼-MD60电机
	...
	if( robot.type<=1 )  Set_Pwm(-2000 ,-3000 ,0,0,0);//高配差速-MD36电机
	else                 Set_Pwm(-2000 ,-3000 ,0,0,0);//顶配差速-MD60电机
	...
	if( robot.type<=2 ) Set_Pwm(-2000,-3000,-4000,-5000,0);//高配麦轮-MD36电机
	else                Set_Pwm(-2000,-3000,-4000,-5000,0);//顶配或旗舰麦轮-MD60电机
	...
	if( robot.type<=3 ) Set_Pwm(-2000,-3000,-4000,-5000,0);//高配四驱-MD36电机
	else                Set_Pwm(-2000,-3000,-4000,-5000,0);//顶配或旗舰四驱-MD60电机
	...
	if( robot.type<=1 ) Set_Pwm(-2000,-3000,-4000,0,0);//高配全向轮-MD36电机
	else                Set_Pwm(-2000,-3000,-4000,0,0);//顶配全向轮-MD60电机
