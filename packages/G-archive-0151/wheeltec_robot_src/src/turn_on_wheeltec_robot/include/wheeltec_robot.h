...
#include "turn_on_wheeltec_robot/SetRgb.h"
using namespace std;
...
class turn_on_robot
{
	...
	private:
		...
		bool Set_LightRgb_Callback(turn_on_wheeltec_robot::SetRgb::Request &req,turn_on_wheeltec_robot::SetRgb::Response &res);
