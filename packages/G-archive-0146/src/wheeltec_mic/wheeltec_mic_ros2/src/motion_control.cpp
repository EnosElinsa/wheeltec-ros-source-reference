...
int Motion::motion_judgement()
{
	...
	if (cmd_vel_msg.linear.x > 0 && (direction_obstacle_x < 1.05 || direction_obstacle_x > 5.23) && radius)
		return 1;
	else if (cmd_vel_msg.linear.x < 0 && (direction_obstacle_x > 2.62 && direction_obstacle_x < 3.66) && radius)
		return 1;
	else if (cmd_vel_msg.angular.z > 0 && direction_obstacle_x < 1.05)
		return 1;
	else if (cmd_vel_msg.angular.z < 0 && direction_obstacle_x > 5.23)
		return 1;
	else
		return 0;
}
