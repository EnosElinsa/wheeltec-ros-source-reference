    ...
    def detection_callback(self, msg):
        ...
        for detection in msg.detections:
            ...
            if class_id == 'red_light':
                ...
                if (size_y>60) and (size_x>30) and score > 0.8 and not (1.50 < self.distance_front < 1.90) and not (1.51 < self.distance_r5 < 1.91):
                    self.side_flag = 1
                ...
                if (size_y>60) and (size_x>60) and score > 0.9:
