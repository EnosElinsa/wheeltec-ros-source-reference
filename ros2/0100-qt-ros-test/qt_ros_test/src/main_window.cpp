...
void qt_ros_test::MainWindow::on_checkBox_key_clicked(bool checked)
{
    ...
    {
        _cmd->write("ros2 launch turn_on_wheeltec_robot wheeltec_sensors.launch.py\n");
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_kcf_clicked(bool checked)
{
    ...
    {
        _cmd->write("sh /home/wheeltec/wheeltec_ros2/src/qt_ros_test/script/kcf.sh\n");
        ui.checkBox__opencamera->setChecked(true);
        ui.checkBox_key->setChecked(true);
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_orb_clicked(bool checked)
{
    ...
    {
        _cmd->write("sh /home/wheeltec/wheeltec_ros2/src/qt_ros_test/script/orb.sh\n");
        ui.checkBox__opencamera->setChecked(true);
        ui.checkBox_key->setChecked(true);
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_rrt_clicked(bool checked)
{
    ...
    {
        _cmd->write("sh /home/wheeltec/wheeltec_ros2/src/qt_ros_test/script/rrt.sh\n");
        ui.checkBox__opencamera->setChecked(true);
        ui.checkBox_key->setChecked(true);
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_path1_clicked(bool checked)
{
    ...
    {
        _cmd->write("sh /home/wheeltec/wheeltec_ros2/src/qt_ros_test/script/path_save.sh\n");
        ui.checkBox_key->setChecked(true);
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_path2_clicked(bool checked)
{
    ...
    {
        _cmd->write("sh /home/wheeltec/wheeltec_ros2/src/qt_ros_test/script/path_follow.sh\n");
        ui.checkBox_key->setChecked(true);
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_tts_clicked(bool checked)
{
    ...
    {
        _cmd->write("ros2 launch tts tts_make.launch.py\n");
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_mic_clicked(bool checked)
{
    ...
    {
        _cmd->write("sh /home/wheeltec/wheeltec_ros2/src/qt_ros_test/script/mic.sh\n");
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_gu1_clicked(bool checked)
{
    ...
    {
        _cmd->write("ros2 launch bodyreader bodyinteraction.launch.py\n");
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_gu2_clicked(bool checked)
{
    ...
    {
        _cmd->write("ros2 launch bodyreader bodyfollow.launch.py\n");
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_gu3_clicked(bool checked)
{
    ...
    {
        _cmd->write("ros2 launch bodyreader final.launch.py\n");
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_ar1_clicked(bool checked)
{
    ...
    {
        _cmd->write("ros2 launch aruco_ros aruco_recognize.launch.py\n");
        btn_disableall(true);
...
void qt_ros_test::MainWindow::on_pushButton_ar2_clicked(bool checked)
{
    ...
    {
        _cmd->write("ros2 launch simple_follower_ros2 aruco_follower.launch.py\n");
        btn_disableall(true);
