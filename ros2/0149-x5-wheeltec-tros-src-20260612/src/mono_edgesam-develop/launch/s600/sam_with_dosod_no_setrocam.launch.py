...
def generate_launch_description():
    ...
    encoder_model_file_name_launch_arg = DeclareLaunchArgument(
        "sam_encoder_model_file_name", default_value=TextSubstitution(text="edgesam_encoder_1024.hbm")
    )
    decoder_model_file_name_launch_arg = DeclareLaunchArgument(
        "sam_decoder_model_file_name", default_value=TextSubstitution(text="edgesam_decoder_1024.hbm")
    )
