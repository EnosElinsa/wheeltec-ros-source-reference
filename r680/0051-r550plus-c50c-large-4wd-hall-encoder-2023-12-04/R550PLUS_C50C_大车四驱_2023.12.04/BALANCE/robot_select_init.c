...
void Robot_Select(void)
{
  ...
  //ADC值分段变量，取决于小车型号数量，目前有6种小车型号，CAR_NUMBER=6
	...
	{	
		...
		if (Car_Mode==6)   Robot_Init(TOP_4WD_DL_wheelspacing,    TOP_4WD_DL_axlespacing,    MD60N_18, Hall_13, _4WD_225); //TOP_4WD_DL         - 顶配4驱独立悬挂常规型
		if (Car_Mode==7)   Robot_Init(TOP_4WD_DL_wheelspacing,    TOP_4WD_DL_axlespacing,    MD60N_47, Hall_13, _4WD_225); //TOP_4WD_DL         - 顶配4驱独立悬挂重载型
		...
		if (Car_Mode==10)  Robot_Init(FlagShip_4WD_DL_wheelspacing, FlagShip_4WD_DL_axlespacing, MD60N_18, Hall_13, _4WD_225); //FlagShip_4WD_DL    - 旗舰4驱独立悬挂常规型
		if (Car_Mode==11)  Robot_Init(FlagShip_4WD_DL_wheelspacing, FlagShip_4WD_DL_axlespacing, MD60N_47, Hall_13, _4WD_225); //FlagShip_4WD_DL    - 旗舰4驱独立悬挂重载型
