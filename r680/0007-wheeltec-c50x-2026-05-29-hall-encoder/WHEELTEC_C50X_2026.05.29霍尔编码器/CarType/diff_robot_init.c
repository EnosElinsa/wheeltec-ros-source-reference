...
void Robot_Select(void)
{
	...
	{
		//高配常规、重载
		case 0: Robot_Init(TOP_DIFF_wheelspacing , MD36N_27 , Hall_13 , TOP_DIFF_WheelDiameter , VEL_KP , VEL_KI); break;
		case 1: Robot_Init(TOP_DIFF_wheelspacing , MD36N_51 , Hall_13 , TOP_DIFF_WheelDiameter , VEL_KP , VEL_KI); break;
		
		//顶配摆式常规、重载
		case 2: Robot_Init(FOUR_WHEEL_DIFF_BS_wheelspacing , MD60N_18 , Hall_13 , FOUR_WHEEL_DIFF_WheelDiameter , VEL_KP , VEL_KI); break;
		case 3: Robot_Init(FOUR_WHEEL_DIFF_BS_wheelspacing , MD60N_47 , Hall_13 , FOUR_WHEEL_DIFF_WheelDiameter , VEL_KP , VEL_KI); break;
		
		//顶配独立常规、重载
		case 4: Robot_Init(FOUR_WHEEL_DIFF_DL_wheelspacing , MD60N_18 , Hall_13 , FOUR_WHEEL_DIFF_WheelDiameter , VEL_KP , VEL_KI); break;
		case 5: Robot_Init(FOUR_WHEEL_DIFF_DL_wheelspacing , MD60N_47 , Hall_13 , FOUR_WHEEL_DIFF_WheelDiameter , VEL_KP , VEL_KI); break;
