...
void Robot_Select(void)
{
	...
	switch( TypeNum )
	{
		...
		//高配版 常规型、重载型
		case 0: Robot_Init(Omni_Turn_Radiaus_180 , MD36N_27 , Hall_13 , FullDirecion_127 , VEL_KP , VEL_KI); break;
		case 1: Robot_Init(Omni_Turn_Radiaus_180 , MD36N_51 , Hall_13 , FullDirecion_127 , VEL_KP , VEL_KI); break;
		
		//顶配版 常规型
		case 2: Robot_Init(Omni_Turn_Radiaus_290 , MD60N_18 , Hall_13 , FullDirecion_127 , VEL_KP , VEL_KI); break;
