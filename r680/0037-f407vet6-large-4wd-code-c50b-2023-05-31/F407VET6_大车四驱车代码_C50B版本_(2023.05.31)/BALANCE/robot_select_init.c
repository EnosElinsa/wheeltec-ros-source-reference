...
//	if()Car_Mode
	#if _4WD
	{	
		if (Car_Mode==0)   Robot_Init(SENIOR_4WD_BS_wheelspacing, SENIOR_4WD_BS_axlespacing, MD36N_27, Hall_13, _4WD_152); //SENIOR_4WD_BS      - 高配4驱摆式悬挂常规型 //BS: Pendulum suspension
		if (Car_Mode==1)   Robot_Init(SENIOR_4WD_BS_wheelspacing, SENIOR_4WD_BS_axlespacing, MD36N_51, Hall_13, _4WD_152); //SENIOR_4WD_BS      - 高配4驱摆式悬挂重载型  
		
		if (Car_Mode==2)   Robot_Init(SENIOR_4WD_DL_wheelspacing, SENIOR_4WD_DL_axlespacing, MD36N_27, Hall_13, _4WD_152); //SENIOR_4WD_DL      - 高配4驱独立悬挂常规型 //DL: Independent suspension 
		if (Car_Mode==3)   Robot_Init(SENIOR_4WD_DL_wheelspacing, SENIOR_4WD_DL_axlespacing, MD36N_51, Hall_13, _4WD_152); //SENIOR_4WD_DL      - 高配4驱独立悬挂重载型
		
		if (Car_Mode==4)   Robot_Init(TOP_4WD_BS_wheelspacing,    TOP_4WD_BS_axlespacing,    MD60N_18, Hall_13, _4WD_225); //TOP_4WD_BS         - 顶配4驱摆式悬挂常规型
		if (Car_Mode==5)   Robot_Init(TOP_4WD_BS_wheelspacing,    TOP_4WD_BS_axlespacing,    MD60N_47, Hall_13, _4WD_225); //TOP_4WD_BS         - 顶配4驱摆式悬挂重载型
		
		if (Car_Mode==6)   Robot_Init(TOP_4WD_DL_wheelspacing,    TOP_4WD_DL_axlespacing,    MD60N_18, Hall_13, _4WD_250); //TOP_4WD_DL         - 顶配4驱独立悬挂常规型
		if (Car_Mode==7)   Robot_Init(TOP_4WD_DL_wheelspacing,    TOP_4WD_DL_axlespacing,    MD60N_47, Hall_13, _4WD_250); //TOP_4WD_DL         - 顶配4驱独立悬挂重载型

		if (Car_Mode==8)   Robot_Init(FlagShip_4WD_BS_wheelspacing, FlagShip_4WD_BS_axlespacing, MD60N_18, Hall_13, _4WD_225); //FlagShip_4WD_BS    - 旗舰4驱摆式悬挂常规型
		if (Car_Mode==9)   Robot_Init(FlagShip_4WD_BS_wheelspacing, FlagShip_4WD_BS_axlespacing, MD60N_47, Hall_13, _4WD_225); //FlagShip_4WD_BS    - 旗舰4驱摆式悬挂重载型
		
		if (Car_Mode==10)  Robot_Init(FlagShip_4WD_DL_wheelspacing, FlagShip_4WD_DL_axlespacing, MD60N_18, Hall_13, _4WD_250); //FlagShip_4WD_DL    - 旗舰4驱独立悬挂常规型
		if (Car_Mode==11)  Robot_Init(FlagShip_4WD_DL_wheelspacing, FlagShip_4WD_DL_axlespacing, MD60N_47, Hall_13, _4WD_250); //FlagShip_4WD_DL    - 旗舰4驱独立悬挂重载型
		
		if (Car_Mode==12)  Robot_Init(TOP_4WD_BS_wheelspacing,    TOP_4WD_BS_axlespacing,    MD60N_47, Hall_13, _4WD_225); //Customized_4WD     - 定制车型
	}
	#elif Omni
	{
