...
void Robot_Select(void)
{
  ...
  if(Car_Mode>10)Car_Mode=10;
	#if Mec
	{	
		if (Car_Mode<=6)  Robot_Init(EIGHT_MORTOR_MEC_wheelspacing, EIGHT_MORTOR_MEC_axlespacing, MD36N_27, Hall_13, Mecanum_152);   
		if (Car_Mode==7)  Robot_Init(EIGHT_MORTOR_MEC_wheelspacing, EIGHT_MORTOR_MEC_axlespacing, MD60N_18, Hall_13, Mecanum_152); 
	}
	#elif Omni
	{
